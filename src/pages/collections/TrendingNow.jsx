...
const TrendingNow = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-12 bg-white font-sans selection:bg-neutral-100">
      
      {/* ১. হেডার টাইটেল */}
      <div className="flex items-center justify-center gap-4 mb-6">
        <div className="h-[1px] bg-gray-300 flex-1 hidden sm:block"></div>
        <h2 className="text-sm font-bold tracking-[0.3em] text-black uppercase whitespace-nowrap">
          Trending Now
        </h2>
        <div className="h-[1px] bg-gray-300 flex-1 hidden sm:block"></div>
      </div>
      ...
      {/* ২. ক্যাটাগরি ট্যাব */}
      <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 mb-10 text-xs tracking-widest font-semibold text-gray-400">
        <button
