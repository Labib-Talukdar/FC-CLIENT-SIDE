...
const TrendingNow = () => {
  ...
  src={
    !product.mainImage
      ? "https://via.placeholder.com/400x600?text=No+Image" // ইমেজ না থাকলে ফলব্যাক
      : product.mainImage.startsWith("http")
      ? product.mainImage // যদি Cloudinary বা External URL হয়
      : `${import.meta.env.VITE_API_URL.replace(/\/$/, "")}/${product.mainImage.replace(/^\//, "")}` // স্ল্যাশ ফিক্স
  }
  alt={product.title}
  onClick={() => navigate(`/product/${product._id}`)}
  onError={(e) => {
    // যদি ইমেজ লোড করতে ব্যর্থ হয় তবে প্লেসহোল্ডার ইমেজ দেখাবে
